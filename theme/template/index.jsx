              ...
              <Col lg={12} sm={24}>
                <div className="home">
                  ...
                  <div className="home-btns">
                    <Link to={messages["app.home.url"]}>
                      <Button type="primary">
                        {messages["app.btn.doc2"]}
                      </Button>
                    </Link>
                    <a href={config.baseConfig.library2} target="__blank">
                      <Button>
                        {`版本号：${packa.version}`}
                      </Button>
                    </a>
                  ...
                  <div className="home-btns">
                    <Link to={messages["app.home.url"]}>
                      <Button type="primary">
                        {messages["app.btn.doc3"]}
                      </Button>
                    </Link>
                    <a href={config.baseConfig.library3} target="__blank">
                      <Button>
                        {`版本号：${packa.version}`}
                      </Button>
                    </a>
